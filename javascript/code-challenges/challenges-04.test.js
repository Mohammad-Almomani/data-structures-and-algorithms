...
let correctName = [];
arr.forEach (animal => correctName.push(callback(animal)));
return correctName;
};
...
const sortByPrice = (arr) => {
  return arr.sort((a,b) => {if (a.price<b.price) return -1});
};
...
const alphabetizeBetter = (arr) => {
  return arr.sort ((a,b)=> { if (a.toLowerCase()<b.toLowerCase()) return -1})
};
...
const sortByLength = (arr) => {
  return arr.sort ((a,b)=> { if (a.length<b.length) return -1})
};
...
const sortNumbersByLength = (arr) => {
  return arr.sort ((a,b)=> { if (a.toString().length<b.toString().length) return -1})
};
...
const sortPeople = (arr) => {
  return arr.sort((a,b) => {if (a.lastName<b.lastName) return -1})
};
...
const sortMeetingsByDay = (arr) => {
  ...
  return arr.sort((a, b) => {
    return weekDaysOrder[a.dayOfWeek] - weekDaysOrder[b.dayOfWeek];
 });
}
